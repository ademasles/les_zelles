# GitHub Copilot Prompt - T7.3 Add Structured Logging
...
Implement ticket T7.3: Add Structured Logging.

## Objective

Create centralized logging and add useful IDs/status/durations while avoiding sensitive content.
...
1. Configure application logging centrally.
2. Log request/document/job/parser/status/duration/error where available.
3. Do not log full documents, prompts, or sensitive contents.
...
- [ ] Logs include useful IDs/statuses.
- [ ] Sensitive contents are not dumped.
- [ ] Existing tests pass.
```
