# GitHub Copilot Prompt - T8.1 Add Golden-File Extraction Tests
...
Implement ticket T8.1: Add Golden-File Extraction Tests.

## Objective

Add regression tests for parser/chunking output using small safe fixtures or mocked fixtures.
...
1. Create fixtures/golden directories.
2. Add tests for parser returns Markdown and structure.
3. Check stable headings/sections rather than exact full text.
4. Add chunker tests preserving heading paths.
